...
window.addEventListener("load", function () {
    ...
    function calculate() {
        ...
        if (billValue && peopleValue && (customTipValue || selectedTip)) {
            ...
            tipText.textContent = '$ ' + tipAmount; //użyć zaokrąglenia do dwóch miejsc po przecinku
            totalText.textContent = '$ ' + totalPerPerson; //użyć zapokrąglenia do dwóch miejsc po przecinku
        } else {
            console.log("BŁĄD")
        }
